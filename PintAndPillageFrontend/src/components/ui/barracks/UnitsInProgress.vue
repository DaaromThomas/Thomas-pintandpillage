    ...
    <div v-if="building" class="unitQueue">
        ...
        <div v-for="(unit, index) in building.productionQueue" :key="unit.key">
            <div :style="[index === 0 ? {'color': 'green'} : {'color': 'grey'}]" class="queueItem">
                ...
                <img :src="require('../../../assets/ui-items/' + unit.unitToProduce.unitName + '.png')" width="28px" height="28px"/>
                <h2>{{unit.unitToProduce.unitName}} -{{unit.amountToProduce}} - {{unit.totalTimeToProduce}}
